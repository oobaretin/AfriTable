...
const TOP_CITIES: { label: string; href: string }[] = [
  ...
  { label: "Seattle", href: "/restaurants?city=Seattle%2C%20WA" },
  { label: "Boston", href: "/restaurants?city=Boston%2C%20MA" },
  { label: "Denver", href: "/restaurants?city=Denver%2C%20CO" },
  { label: "Austin", href: "/restaurants?city=Austin%2C%20TX" },
  { label: "San Francisco", href: "/restaurants?city=San%20Francisco%2C%20CA" },
  { label: "New Orleans", href: "/restaurants?city=New%20Orleans%2C%20LA" },
