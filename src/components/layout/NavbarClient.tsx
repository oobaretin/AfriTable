...
export function NavbarClient({ user, profile }: NavbarClientProps) {
  ...
  if (!mounted) {
    return (
      <header className="sticky top-0 w-full border-b bg-white relative z-[100]">
  ...
  return (
    <header className="sticky top-0 w-full border-b bg-white relative z-[100]">
      <div className="mx-auto flex h-24 max-w-6xl items-center justify-between px-6 relative z-[100]">
        <div className="flex items-center gap-6 relative z-[100]">
          <Link href="/" className="flex items-center gap-2 relative z-[100] pointer-events-auto cursor-pointer" prefetch={false}>
            <Image
              src="/logo.png"
              alt="AfriTable"
              width={420}
        ...
        <div className="flex items-center gap-2 relative z-[100]">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="outline" className="md:hidden pointer-events-auto cursor-pointer relative z-[100]" aria-label="Open menu">
                Menu
              </Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-sm">
              ...
              {mounted && (
                <div className="grid gap-2">
                  <Button asChild variant="ghost" className="justify-start pointer-events-auto cursor-pointer relative z-[100]">
                  ...
                  {user ? (
                    <>
                      ...
                      <form action={signOutAction}>
                        <Button type="submit" variant="ghost" className="w-full justify-start pointer-events-auto cursor-pointer relative z-[100]">
                          Sign out
                        </Button>
                      </form>
                    </>
          ...
          {mounted && (
            <div className="hidden items-center gap-2 md:flex relative z-[100]">
              {user ? (
                ...
                <>
                  <Button asChild variant="outline" className="pointer-events-auto cursor-pointer relative z-[100]">
                    <Link href="/login" prefetch={false} className="pointer-events-auto">Sign in</Link>
                  </Button>
                  <Button asChild className="pointer-events-auto cursor-pointer relative z-[100]">
