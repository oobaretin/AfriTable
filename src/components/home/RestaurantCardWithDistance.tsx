    ...
    <div className="group bg-white/5 border border-white/10 rounded-xl p-6 hover:border-[#C69C2B]/30 hover:bg-white/10 transition-all duration-300 relative z-10 pointer-events-auto">
      ...
      <div className="flex gap-3 mt-6">
        <Link
          ...
          className="flex-1 bg-white/10 hover:bg-white/20 text-white text-sm font-semibold px-4 py-2.5 rounded-lg transition-colors text-center relative z-50 pointer-events-auto cursor-pointer"
          prefetch={false}
        >
          View Details
        </Link>
